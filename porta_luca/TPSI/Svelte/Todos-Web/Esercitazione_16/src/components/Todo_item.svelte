...
<Cell>
    <input type="text" class="todo {todo.done==true ? 'todo-done':''}" id="{todo.id}" placeholder="Inserire nuovo ToDo" bind:value={todo.task} on:change={edit}>
</Cell>
<Cell>
...
<style>
    ...
    .todo-done{text-decoration: line-through;opacity: 0.3;}
</style>
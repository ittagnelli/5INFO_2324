...
<div class="contanier">
    ...
    <form method="post" action="?/{action}">
        ...
        <div>
            <input type="text" id="cognome" name="cognome" size=40 autocomplete="off" bind:value={cognome}/>
            <p class={error && cognome?.length == 0 ? '' : 'hidden'}>Cognome invalido</p>
        </div>
        <div><label for="eta">Eta</label></div>
        <div>
            <input type="number" id="eta" name="eta" size=40 autocomplete="off" bind:value={eta}/>
